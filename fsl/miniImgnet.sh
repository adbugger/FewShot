...
exp_dir=$( readlink -f "../miniImgnet_500epoch");
...
# exp2_dir="miniImgnet_round3/CropResize_GaussBlur_runs";
...
# exp3_dir="miniImgnet_round3/ColorDistort_GaussBlur_runs";
...
# exp4_dir="miniImgnet_round3/CropResize_ColorDistort_runs";
